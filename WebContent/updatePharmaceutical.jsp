    ...
    <form action="PharmaceuticalControllerServlet" class="form-horizontal" method="POST" >
        <fieldset>
            ...
            <div class="content-title">
                <h2>UPDATE PHARMACEUTICAL</h2>
            </div>
            
            <!-- Input for send info of request-->
            <input type="hidden" name="infoPost" value="updateDb">
            
            <!-- For Updating purpose-->
            <input type="hidden" name="medId" value="${tmpMedicine.id}">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control form-control-sm" id="phId" name="phId" value="${tmpMedicine.id}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control form-control-sm" id="phName" name="phName" placeholder="Pharmacetical Name" value="${tmpMedicine.name}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control form-control-sm" id="phBrand" name="phBrand" value="${tmpMedicine.brandName}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control form-control-sm" id="phPrice" name="phPrice" value="${tmpMedicine.price}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control form-control-sm" id="phQty" name="phQty" value="${tmpMedicine.qty}">
                </div>
            </div>
